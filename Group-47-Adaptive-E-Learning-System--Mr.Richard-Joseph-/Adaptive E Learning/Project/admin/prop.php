  ...
  <!-- services -->
	...
	<section>  
		<div class="container" style="margin-top:10px;padding:20px">
			<div class="row">
				<div class="col-md-12">
				<div class="well well-sm text-center"><h2>Top 10 Visited Objects</h2></div>
				<?php 
				
				$conn=mysqli_connect('localhost','root','');
					mysqli_select_db($conn,'adaptive');
					$sql="	SELECT * FROM (
							SELECT * FROM topic_1 ORDER BY count DESC LIMIT 10
							) topic_1 ORDER BY count desc";
...
<!--  Top ten visited object ends -->


<section>
	<div class="container">
		<div class="row">
		<div class="well well-sm text-center"><h2>Last Updated object</h2></div>
			<div class="col-md-12">
				<?php 
				
				$conn=mysqli_connect('localhost','root','');
					mysqli_select_db($conn,'adaptive');
					$sql="SELECT *,MAX(status) AS LastUpdated from topic_1";
					$result=mysqli_query($conn,$sql);
