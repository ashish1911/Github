		...
		<div class="container" style="margin-top:10px;padding:20px">
			<div class="row">
				...
				$conn=mysqli_connect('localhost','root','');
					...
					$uid = $row_product['uid'];
					$uname = $row_product['name'];
					$uemail = $row_product['email'];
					$upass = $row_product['pass'];
					?>
					
				<div class='table-responsive'>      
					<form class="form-horizontal" action="edit_action.php" method="post" enctype="multipart/form-data">
					...
					<td> <?php echo $uid ?></td>
					<td> <input type='input' name="upname" value='<?php echo $uname ?>' /> </td>
					<td> <input type='input' name="upemail" value='<?php echo $uemail ?>' /> </td>
					<td> <input type='input' name="uppass" value='<?php echo $upass ?>' /> </td>
					<td> <button type="submit" name="update"><i class="fa fa-bookmark-o" style='font-size:30px' aria-hidden="true"></i></button> </td>
					</tr>
					</tbody>
					</table>
					</form>
